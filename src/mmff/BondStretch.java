...
public class BondStretch implements EnergyTerm {
     ...
     */
    public BondStretch(Tables table, Molecule mol, int bond) {
     ...
     */
    public BondStretch(Tables table, Molecule mol, int a1, int a2) {
        this.a1 = a1;
        this.a2 = a2;
     ...
     */
    public static List<BondStretch> findIn(Tables t, Molecule mol) {
