...
public class TorsionAngle implements EnergyTerm {
     ...
     */
    public TorsionAngle(Tables table, Molecule mol, int a1, int a2,
            int a3, int a4) {
        this.a1 = a1;
        this.a2 = a2;
        this.a3 = a3;
        ...
        mmff.table.Torsion.Kb kbs = table.torsion.getForceConstants(mol,
                a1, a2, a3, a4);
        v1 = kbs.v1;
        v2 = kbs.v2;
        v3 = kbs.v3;
     ...
     */
    public static List<TorsionAngle> findIn(Tables t, Molecule mol) {
