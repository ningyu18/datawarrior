...
public final class Angle implements mmff.Searchable {
     ...
     *      found.
     */
    public int index(Molecule mol, int a1, int a2,
            int a3) {
     ...
     *      empirically.
     */
    public double theta(Molecule mol, int a1, int a2,
            int a3) {
     ...
     *      empirically.
     */
    public double ka(Molecule mol, int a1, int a2,
            int a3) {
        int index = index(mol, a1, a2, a3);
     ...
     */
    private double getEmpiricalTheta0(Molecule mol, int a1, int a2, int a3) {
     ...
     */
    private double getEmpiricalKa(Molecule mol, int a1, int a2, int a3,
            double theta0) {
