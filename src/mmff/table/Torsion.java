...
public final class Torsion implements mmff.Searchable {
    // indices: 0, 1, 2, 3, 4
     ...
     */
    public Kb getForceConstants(Molecule mol, int a1, int a2, int a3, int a4) {
        int a1t = mol.getAtomType(a1);
        int a2t = mol.getAtomType(a2);
        int a3t = mol.getAtomType(a3);
        int a4t = mol.getAtomType(a4);
        int tort = mmff.type.Torsion.getType(t, mol, a1, a2, a3, a4);
