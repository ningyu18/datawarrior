...
import mmff.Molecule;
import mmff.RingBoolean;
...
public class Atom {
     ...
     */
    public static int getType(Molecule mol, int atom) {
     ...
     *  @return The mmff atom type.
     */
    private static int getHeavyType(Molecule mol, int atom) {
        // Aromatic Atoms
     ...
     *  @return The mmff atom type.
     */
    private static int getHydrogenType(Molecule mol, int atom) {
        for (int i=0; i<mol.getAllConnAtoms(atom); i++) {
            int nbr = mol.getConnAtom(atom, i);
     ...
     */
    private static boolean isAtomNOxide(Molecule mol, int atom) {
     ...
     */
    public static int inRings(Molecule mol, int atom) {
     ...
     *      false otherwise.
     */
    public static boolean isInAromaticRingOfSize(Molecule mol, int atom,
            int size) {
        if (mol.isAromaticAtom(atom)) {
            RingCollection rings = mol.getRingSet();
     ...
     */
    public static RingBoolean ringIsMMFFAromatic(Molecule mol, int r) {
        RingCollection rings = mol.getRingSet();
     ...
     */
    public static int degree(Molecule mol, int atom) {
     ...
     *      otherwise.
     */
    public static boolean inRingOfSize(Molecule mol, int atom, int size) {
     ...
     *      otherwise.
     */
    public static boolean inSameRing(Molecule mol, int a1, int a2, int size) {
