...
public final class Angle {
     ...
     */
    public static boolean inRingOfSize(Molecule mol, int a1, int a2,
            int a3, int size) {
     ...
     *          types is 2.
     */
    public static int getType(Tables table, Molecule mol, int a1,
            int a2, int a3) {
     ...
     */
    public static int getStbnType(Tables table, Molecule mol, int a1,
            int a2, int a3) {
