...
public class StretchBend implements EnergyTerm {
     ...
     */
    public StretchBend(Tables table, Molecule mol, int a1, int a2,
            int a3) {
        this.mol = mol;
        this.a1 = a1;
        this.a2 = a2;
     ...
     */
    public static boolean valid(Tables table, Molecule mol, int a1,
            int a2, int a3) {
     ...
     */
    public static List<StretchBend> findIn(Tables t, Molecule mol) {
