...
public class OutOfPlane implements EnergyTerm {
     ...
     */
    public OutOfPlane(Tables table, Molecule mol, int ac, int a1,
            int a2, int a3) {
        this.ac = ac; // j
        this.a1 = a1; // i
        this.a2 = a2; // k
     ...
     */
    public static List<OutOfPlane> findIn(Tables t, Molecule mol) {
    ...
    public static List<OutOfPlane> findIn(Molecule mol) {
        return findIn(ForceField.table(ForceField.MMFF94), mol);
    }
}
