...
public class Dockable extends JPanel {
	 ...
	 */
	public Dockable(JDockingPanel dockingPanel, Component content, String title, ActionListener al, boolean isClosable) {
	 ...
	 */
	public Dockable(JDockingPanel dockingPanel, Component content, String title, ActionListener al, boolean isClosable, boolean hasMenuButton) {
