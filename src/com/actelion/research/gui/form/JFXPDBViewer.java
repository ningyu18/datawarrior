	...
	public JFXPDBViewer () {
		Platform.runLater(new Runnable() {
			...
			public void run () {
				...
				mScene = new V3DScene(root, 512, 384);
...
//							mol = parser.load("/home/thomas/data/pdb/reninOpenFlap.pdb");
							mol = parser.load("Name", new StringReader(new String(pdbData)));
						...
						if (this == mLatestRunnable && pdbData != null) {
							...
							vm = new V3DMolecule(conformer, MoleculeArchitect.CONSTRUCTION_MODE_WIRES);
							vm.setSurface(0, V3DMolecule.SURFACE_FILLED, SurfaceMesh.SURFACE_COLOR_ATOMIC_NOS, 0.5);
							vm.activateEvents();
							}
						if (this == mLatestRunnable) {
