...
public class SubGraphExtractor {
    ...
    public List<SubGraphIndices> extract(StereoMolecule molOrig) {
        ...
        //
        // Merge brigded aliphatic rings
        // Only in place for heavily bridged rings.
        mergeBrigdedAliphaticRings(mol, liFragment);
    ...
    private static void mergeBrigdedAliphaticRings(StereoMolecule mol, List<SubGraphIndices> liFragment){
