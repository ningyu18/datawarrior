...
public class StereoIsomerEnumerator {
	 ...
	 * defined relative stereo configurations, then it represents represents
	 * multiple stereo isomers. The StereoIsomerEnumerator generates all
	 * individual stereo isomers of the passes molecule. If the passed molecule
	 * does not include absolute stereo centers (or atrop isomeric configuration),
