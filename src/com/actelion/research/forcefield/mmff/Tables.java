...
import com.actelion.research.forcefield.mmff.table.Angle;
import com.actelion.research.forcefield.mmff.table.Atom;
import com.actelion.research.forcefield.mmff.table.Bndk;
import com.actelion.research.forcefield.mmff.table.Bond;
import com.actelion.research.forcefield.mmff.table.Charge;
import com.actelion.research.forcefield.mmff.table.CovRad;
import com.actelion.research.forcefield.mmff.table.Def;
import com.actelion.research.forcefield.mmff.table.Dfsb;
import com.actelion.research.forcefield.mmff.table.HerschbachLaurie;
import com.actelion.research.forcefield.mmff.table.Stbn;
import com.actelion.research.forcefield.mmff.table.Torsion;
...
public final class Tables {
    ...
    public final com.actelion.research.forcefield.mmff.table.OutOfPlane  oop;      // Out of plane.
    public final Charge      chge;     // Charge.
    public final Stbn                   stbn;     // Stretch bending.
    public final Torsion                torsion;  // Torsional angles.
    public final com.actelion.research.forcefield.mmff.table.VanDerWaals vdws;     // Van der Waals.
    ...
    public Tables(
        ...
        chge     = new      			Charge(this, csv_pbci, csv_bci);
        ...
        oop      = new  	       com.actelion.research.forcefield.mmff.table.OutOfPlane(this, csv_oop);
        stbn     = new                   Stbn(this, csv_stbn);
        torsion  = new                Torsion(this, csv_torsion);
        vdws     = new 			  com.actelion.research.forcefield.mmff.table.VanDerWaals(this, csv_vdws);
    }
    ...
    public static Tables newMMFF94() {
        return new com.actelion.research.forcefield.mmff.Tables(
