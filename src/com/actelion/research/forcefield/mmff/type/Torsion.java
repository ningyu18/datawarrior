...
public final class Torsion {
     ...
     */
    public static int getType(Tables table, FFMolecule mol, int a1, int a2, int a3,
            int a4) {
        ...
        if (size == 5 && (mol.getMMFFAtomType(a1) == 1
                    || mol.getMMFFAtomType(a2) == 1
                    || mol.getMMFFAtomType(a3) == 1
                    || mol.getMMFFAtomType(a4) == 1))
            return 50 + tort;
     ...
     *  @param a4 Atom 4.
     */
    public static int inRingOfSize(FFMolecule mol, int a1, int a2,
            int a3, int a4) {
