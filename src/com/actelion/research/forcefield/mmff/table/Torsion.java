...
public final class Torsion implements Searchable {
     ...
     */
    public Kb getForceConstants(FFMolecule mol, int a1, int a2, int a3, int a4) {
        int a1t = mol.getMMFFAtomType(a1);
        int a2t = mol.getMMFFAtomType(a2);
        int a3t = mol.getMMFFAtomType(a3);
        int a4t = mol.getMMFFAtomType(a4);
        int tort = com.actelion.research.forcefield.mmff.type.Torsion.getType(t, mol, a1, a2, a3, a4);
