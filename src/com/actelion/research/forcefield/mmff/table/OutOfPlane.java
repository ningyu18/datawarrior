...
public class OutOfPlane implements Searchable {
     ...
     */
    public double getKoop(FFMolecule mol, int ac, int a1, int a2,
            int a3) {
        int act = mol.getMMFFAtomType(ac);
        int[] nbr = new int[]{
            mol.getMMFFAtomType(a1),
            mol.getMMFFAtomType(a2),
            mol.getMMFFAtomType(a3)};
