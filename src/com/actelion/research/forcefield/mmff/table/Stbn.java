...
public final class Stbn implements Searchable {
     ...
     */
    public int index(FFMolecule mol, int a1, int a2, int a3) {
        int a1t = mol.getMMFFAtomType(a1);
        int a2t = mol.getMMFFAtomType(a2);
        int a3t = mol.getMMFFAtomType(a3);
        int angt = com.actelion.research.forcefield.mmff.type.Angle.getStbnType(t, mol, a1, a2, a3);
     ...
     */
    public double kba(FFMolecule mol, int a1, int a2, int a3) {
        int a1t = mol.getMMFFAtomType(a1);
        int a3t = mol.getMMFFAtomType(a3);
        int b1t = com.actelion.research.forcefield.mmff.type.Bond.getType(t, mol, a1, a2);
        int b2t = com.actelion.research.forcefield.mmff.type.Bond.getType(t, mol, a2, a3);
