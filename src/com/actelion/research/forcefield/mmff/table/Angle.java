...
import com.actelion.research.forcefield.mmff.Constants;
import com.actelion.research.forcefield.mmff.Csv;
import com.actelion.research.forcefield.mmff.Search;
...
public final class Angle implements Searchable {
     ...
     *      found.
     */
    public int index(FFMolecule mol, int a1, int a2,
            int a3) {
        int a1t = mol.getMMFFAtomType(a1);
        int a2t = mol.getMMFFAtomType(a2);
        int a3t = mol.getMMFFAtomType(a3);
        int angt = com.actelion.research.forcefield.mmff.type.Angle.getType(t, mol, a1, a2, a3);
     ...
     *      empirically.
     */
    public double theta(FFMolecule mol, int a1, int a2,
            int a3) {
     ...
     *      empirically.
     */
    public double ka(FFMolecule mol, int a1, int a2,
            int a3) {
        int index = index(mol, a1, a2, a3);
     ...
     */
    private double getEmpiricalTheta0(FFMolecule mol, int a1, int a2, int a3) {
        if (com.actelion.research.forcefield.mmff.type.Angle.inRingOfSize(mol, a1, a2, a3, 3))
            return 60.0;
        else if (com.actelion.research.forcefield.mmff.type.Angle.inRingOfSize(mol, a1, a2, a3, 4))
            return 90.0;
     ...
     */
    private double getEmpiricalKa(FFMolecule mol, int a1, int a2, int a3,
            double theta0) {
        ...
        if (com.actelion.research.forcefield.mmff.type.Angle.inRingOfSize(mol, a1, a2, a3, 4))
            beta *= 0.85;
        else if (com.actelion.research.forcefield.mmff.type.Angle.inRingOfSize(mol, a1, a2, a3, 3))
            beta *= 0.05;
