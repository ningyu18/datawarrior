...
public class RayTraceActionProvider implements ActionProvider<MoleculeViewer> {
	private Frame mParentFrame;

	public RayTraceActionProvider(Frame parent) {
		mParentFrame = parent;
		}
	...
	public void showRaytraceDialog(Frame parent, MoleculeViewer viewer) {
		...
		float dy = MoleculeRenderer.DEFAULT_CAMERA_DISTANCE * (1f - 28f / zoomPercent);	// zoomPercent=28f leads to similarly sized molecule in sunflow
		...
		*/
		...
		new MoleculeRaytraceDialog(parent, mol, 40f, 0f, 1f, fov);
		}
	}
