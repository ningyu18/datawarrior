...
public class JEPRefValueOfCategoryFunction extends PostfixMathCommand {
	public static final String FUNCTION_NAME = "refvalue";
	private DETaskCalculateColumn	mParentTask;
	private CompoundTableModel		mTableModel;
    private TreeMap<byte[],byte[]>	mCategoryValueMap;

	public JEPRefValueOfCategoryFunction(DETaskCalculateColumn parentTask, CompoundTableModel tableModel) {
        super();
