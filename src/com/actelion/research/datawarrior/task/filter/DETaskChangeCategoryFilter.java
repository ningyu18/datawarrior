...
public class DETaskChangeCategoryFilter extends DEAbstractFilterTask {
	public static final String TASK_NAME = "Change Category Filter";

	private static Properties sRecentConfiguration;

	public DETaskChangeCategoryFilter(Frame parent, DEPruningPanel pruningPanel, JFilterPanel filter) {
	...
	public JFilterPanel createFilterUI() {
		return new JCategoryFilterPanel(getTableModel());
		}

	@Override
	protected String getColumnQualificationError(int column) {
		return getTableModel().isColumnTypeCategory(column) ? null
				: "Category filters can be applied to category data only.";
		}

	@Override
	public int getFilterType() {
		return JFilterPanel.FILTER_TYPE_CATEGORY;
		}
	}
