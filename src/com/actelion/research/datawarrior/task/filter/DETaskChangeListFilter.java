...
public class DETaskChangeListFilter extends DEAbstractFilterTask {
	public static final String TASK_NAME = "Change List Filter";

	private static Properties sRecentConfiguration;

	public DETaskChangeListFilter(Frame parent, DEPruningPanel pruningPanel, JFilterPanel filter) {
	...
	public JFilterPanel createFilterUI() {
		return new JHitlistFilterPanel(getTableModel());
		}
