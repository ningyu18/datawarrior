...
public class DETaskChangeStructureFilter extends DEAbstractFilterTask {
	public static final String TASK_NAME = "Change Structure Filter";

	public DETaskChangeStructureFilter(Frame parent, DEPruningPanel pruningPanel, JFilterPanel filter) {
	...
	public JFilterPanel createFilterUI() {
		return new JSingleStructureFilterPanel(getParentFrame(), getTableModel(), null);
		}
	...
	public int getFilterType() {
		return JFilterPanel.FILTER_TYPE_STRUCTURE;
		}
	}
