...
public class DETaskEnableAllFilters extends DETaskWithEmptyConfiguration {
    public static final String TASK_NAME = "Enable All Filters";

	private DEPruningPanel      mPruningPanel;

	public DETaskEnableAllFilters(DEFrame parent) {
		super(parent, false);
	...
	public void runTask(Properties configuration) {
		mPruningPanel.enableAllFilters();
		}
