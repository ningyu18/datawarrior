...
public class CustomLabelPositionWriter implements DataDependentPropertyWriter {
	public static final String PROPERTY_NAME = "Custom Label Positions";

	private DEMainPane	mMainPane;

	public CustomLabelPositionWriter(DEMainPane mainPane) {
		mMainPane = mainPane;
	}
