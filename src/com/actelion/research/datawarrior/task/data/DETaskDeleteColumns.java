...
public class DETaskDeleteColumns extends ConfigurableTask {
	...
	public DETaskDeleteColumns(Frame owner, CompoundTableModel tableModel, boolean isInteractive) {
		super(owner, false);
	...
	public Properties getPredefinedConfiguration() {
		...
		configuration.setProperty(PROPERTY_COLUMN_LIST, mTableModel.getColumnTitleNoAlias(mColumn));
