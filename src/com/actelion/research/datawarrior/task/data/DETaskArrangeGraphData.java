...
public class DETaskArrangeGraphData extends ConfigurableTask implements ActionListener,Runnable {
	...
	public static final String TASK_NAME = "Arrange Graph Data";
	...
	public DETaskArrangeGraphData(DEFrame parent) {
		super(parent, true);
		mParentFrame = parent;
			...
			try {
				SwingUtilities.invokeAndWait(new Runnable() {
					public void run() {
						...
						vpanel2.getVisualization().setTreeViewMode(JVisualization.cTreeViewModeVTree, 5, false, false);
						}
					} );
				}
			catch (Exception e) {}
